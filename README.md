...
Below are example screenshots demonstrating this project in action:
...
![Postman Tests 2 Screenshot](screenshots/postman-tests-2.png)

---

## 🎯 Future Improvements

While the core features are complete, the next major step would be implementing a **checkout process.** Currently, users can add products to their cart, but there’s no functionality to convert the cart into a finalized order. Adding checkout, payments, and order tracking would make EasyShop a fully functional e-commerce platform.
